...
fn main() {
    ...
    let mut sphere_1 = GameObject::Sphere_default(0.4, [0, 0, 0], [1.0, 2.0, 10.], 10., 1.0, 0.01);
    ...
    let mut sphere_3 =
        GameObject::Sphere_default(0.5, [255, 100, 0], [2.0, 10.0, 10.], 10., 1.0, 0.01);
    sphere_3.add_velocity([8.0, -5.0, 1.0]);
    renderer.add_obj(&sphere_3).unwrap();
    scene.add(sphere_3);

    let mut sphere_4 =
        GameObject::Sphere_default(0.1, [255, 0, 255], [-1.0, 10.0, 10.], 10., 1.0, 0.01);
    sphere_4.add_velocity([8.0, 0.0, 0.0]);
    renderer.add_obj(&sphere_4).unwrap();
    scene.add(sphere_4);

    let mut sphere_5 =
        GameObject::Sphere_default(0.2, [255, 40, 0], [0.0, 5.0, 5.], 10., 1.0, 0.01);
